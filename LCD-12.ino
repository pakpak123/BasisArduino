...
for(int x=15 ; x>=0 ; x--)
{
lcd.createChar(x, char0);
lcd.createChar(x+1, char1);
lcd.createChar(x+2, char2);
lcd.createChar(x+3, char3);
lcd.createChar(x+4, char4);
lcd.createChar(x+5, char5);
lcd.clear();
lcd.write(x); // write character 0
lcd.write(x+1); // write character 1
lcd.write(x+2); // write character 2
lcd.write(x+3); // write character 3
lcd.write(x+4); // write character 4
lcd.write(x+5); // write character 5
